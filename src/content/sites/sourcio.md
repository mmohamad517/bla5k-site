...
faqs:
  ...
  - q: What can you do with Sourcio?
    a: "In practice, Sourcio is used to speed up ai research work: Sourcio AI Hiring Agent is an automates talent sourcing by suggesting top candidates based on interests and experiences, integrating with ATS platforms for streamlined sourcing, saving time and effort while vetting over 5,0..Description in 2 lines: Sourcio AI tool automates talent sourcing by identifying top candidates through their interests and experiences, seamlessly integrating with ATS platforms to streamline the hiring process.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Sourcio best for?
...
*Official resource: [Sourcio](https://sourcio.co/)*
