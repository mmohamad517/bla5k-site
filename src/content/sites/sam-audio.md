...
faqs:
  - q: What is Sam Audio?
    a: SAM Audio uses Meta’s Segment Anything Audio Model to isolate vocals, instruments, speech and effects from mixes via multimodal prompts (text, visual, time-span). It produces target and residual stems at original sample rates for production, post, and research. That is the core of what Sam Audio does — ai content generation handled by a dedicated AI tool rather than a general-purpose chatbot.
  - q: Is Sam Audio free?
