...
faqs:
  ...
  - q: What can you do with Airtable AI assistant?
    a: "In practice, Airtable AI assistant is used to speed up no-code building work: Airtable Assistant is a no-code app-building platform that enhances workflows with AI, offering task automation, customizable visualizations, and reporting tools.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Airtable AI assistant best for?
  ...
  - q: How do I start with Airtable AI assistant?
...
*Official resource: [Airtable AI assistant](https://www.airtable.com/platform/ai)*
