...
faqs:
  ...
  - q: What can you do with Nettle.ai?
    a: "In practice, Nettle.ai is used to speed up ai avatar generation work: People Nettle creates customizable, lifelike digital humans for brands, enhancing customer engagement through interactive, voice-responsive avatars powered by natural language processing.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Nettle.ai best for?
  ...
  - q: How do I start with Nettle.ai?
...
*Official resource: [Nettle.ai](https://nettle.ai)*
