...
faqs:
  ...
  - q: What can you do with Datavise?
    a: "In practice, Datavise is used to speed up ai agent workflows work: Datavise provides generative AI, RAG and LLM integration with AI agents for automated workflows, combined with data architecture, governance and cloud AI infrastructure, BI visualization and compliance support to accelerate model deployment and data-driven decision-making.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Datavise best for?
  ...
  - q: How do I start with Datavise?
...
*Official resource: [Datavise](https://www.datavise.ai)*
