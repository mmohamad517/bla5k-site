...
faqs:
  ...
  - q: What can you do with Flexberry AI Assistant?
    a: "In practice, Flexberry AI Assistant is used to speed up ai planning work: Converts natural‑language requirements into structured artifacts, auto‑generating mock‑up forms, SQL, UML, database schemas and business‑process models, assembling documentation and accelerating MVP creation for organizations via a web interface adaptable to workflow.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Flexberry AI Assistant best for?
  ...
  - q: How do I start with Flexberry AI Assistant?
...
*Official resource: [Flexberry AI Assistant](https://ai.flexberry.net/)*
