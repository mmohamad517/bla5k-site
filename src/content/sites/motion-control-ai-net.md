...
faqs:
  ...
  - q: What can you do with Motion Control AI?
    a: "In practice, Motion Control AI is used to speed up ai content generation work: motion-control-ai.net is an AI video generator that extracts full-body motion, facial expressions, hand gestures, and lip sync from a reference video to animate any character image without manual rigging or mocap suits.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Motion Control AI best for?
  ...
  - q: How do I start with Motion Control AI?
...
*Official resource: [Motion Control AI](https://motion-control-ai.net/)*
