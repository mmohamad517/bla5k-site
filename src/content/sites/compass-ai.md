...
example: Give Compass AI one real task — a prompt, a file, or a request — and it returns a usable result for your web3 and ai agents workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Compass AI?
    a: "In practice, Compass AI is used to speed up web3 and ai agents work: Compass AI autonomously routes non-custodial USDC across blockchains and DeFi protocols, executing sub-500ms atomic settlements while rebalancing per user-defined risk bands and whitelists.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Compass AI best for?
  ...
  - q: How do I start with Compass AI?
...
*Official resource: [Compass AI](https://usecompassai.com)*
