...
example: Give Base for music one real task — a prompt, a file, or a request — and it returns a usable result for your ai marketing workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Base for music?
    a: "In practice, Base for music is used to speed up ai marketing work: Base for Music centralizes marketing data for music entities, delivering real‑time campaign analytics, Spotify popularity scores, and audience profiling.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Base for music best for?
  ...
  - q: How do I start with Base for music?
...
*Official resource: [Base for music](https://www.baseformusic.com)*
