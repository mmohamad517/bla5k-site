...
example: Give WeInvest one real task — a prompt, a file, or a request — and it returns a usable result for your web3 and ai agents workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with WeInvest?
    a: "In practice, WeInvest is used to speed up web3 and ai agents work: WeInvest is an AI‑driven crypto platform featuring a multi‑agent dashboard for real‑time market analysis and automated decisions.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is WeInvest best for?
  ...
  - q: How do I start with WeInvest?
...
*Official resource: [WeInvest](https://weinvest.money)*
