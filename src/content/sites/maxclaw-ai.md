...
faqs:
  ...
  - q: What can you do with MaxClaw AI?
    a: "In practice, MaxClaw AI is used to speed up ai agent workflows work: Maxclaw is a cloud-hosted AI agent built on minimax m2.5, offering one‑click deployment, persistent long‑term memory (200k+ tokens), persona customization, messaging integrations (Telegram/Discord/Slack), and tooling for browsing, code execution, file analysis and automation.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is MaxClaw AI best for?
  ...
  - q: How do I start with MaxClaw AI?
...
*Official resource: [MaxClaw AI](https://agent.minimax.io/max-claw)*
