...
faqs:
  ...
  - q: What can you do with Little-Coder?
    a: "In practice, Little-Coder is used to speed up ai assistance work: little-coder is a Pi-based coding agent for running 5–25 GB local LLMs via llama.cpp or Ollama, offering Python/Node CLIs and TypeScript extensions, reproducible benchmarks, build/serve guides, and tools for local code generation, on-device development, and evaluation.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Little-Coder best for?
  ...
  - q: How do I start with Little-Coder?
...
*Official resource: [Little-Coder](https://github.com/itayinbarr/little-coder)*
