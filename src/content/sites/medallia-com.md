...
example: Give Medallia one real task — a prompt, a file, or a request — and it returns a usable result for your ai customer support workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Medallia?
    a: "In practice, Medallia is used to speed up ai customer support work: medallia.com is an AI-powered experience management platform that captures omnichannel feedback and analyzes it to provide real-time insights.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Medallia best for?
  ...
  - q: How do I start with Medallia?
...
*Official resource: [Medallia](https://medallia.com)*
