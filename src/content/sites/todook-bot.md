...
example: Give Todook bot one real task — a prompt, a file, or a request — and it returns a usable result for your ai work workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Todook bot?
    a: "In practice, Todook bot is used to speed up ai work work: Todook is a 24/7 AI assistant that automates customer inquiries and sales across social channels.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Todook bot best for?
  ...
  - q: How do I start with Todook bot?
...
*Official resource: [Todook bot](https://todook.io)*
