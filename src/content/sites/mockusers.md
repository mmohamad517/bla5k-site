...
faqs:
  ...
  - q: What can you do with MockUsers?
    a: "In practice, MockUsers is used to speed up ai agent workflows work: MockUsers analyzes landing pages, auto-detects ideal customer profiles and deploys AI visitor agents to simulate behavior, pinpoint sentence-level doubts and conversion blockers, rank issues by impact, and generate ICP-tailored hero, bullets and CTA rewrites with scored actionable fixes.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is MockUsers best for?
  ...
  - q: How do I start with MockUsers?
...
*Official resource: [MockUsers](https://mockusers.xyz)*
