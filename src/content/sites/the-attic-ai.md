...
faqs:
  ...
  - q: What can you do with The Attic AI?
    a: "In practice, The Attic AI is used to speed up ai assistance work: Attic AI offers no‑code tools to create and deploy custom LLMs that convert internal documents into searchable knowledge bases, automate grant and proposal drafting for contractors and universities, and analyze congressional appropriations for compliance—all on secure on‑prem or private cloud.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is The Attic AI best for?
  ...
  - q: How do I start with The Attic AI?
...
*Official resource: [The Attic AI](https://www.theattic.ai)*
