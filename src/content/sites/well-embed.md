...
faqs:
  ...
  - q: What can you do with Well Embed?
    a: "In practice, Well Embed is used to speed up ai agent workflows work: Well Embed provides a unified API and connector suite for automated invoice and receipt retrieval from email, portals, cloud storage, chat apps and vendor platforms, delivering raw documents or structured JSON with OCR/LLM extraction, deduplication and ERP integrations.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Well Embed best for?
  ...
  - q: How do I start with Well Embed?
...
*Official resource: [Well Embed](https://embed.wellapp.ai)*
