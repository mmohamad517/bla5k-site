...
faqs:
  ...
  - q: What can you do with anti.space?
    a: "In practice, anti.space is used to speed up ai assistance work: Antispace is an AI operating system that provides customizable AI sidekicks to manage email, calendar, notes, search and tasks, integrating web, mail and documents, using dynamic model selection, workflow automation, persistent memory and privacy controls.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is anti.space best for?
  ...
  - q: How do I start with anti.space?
...
*Official resource: [anti.space](https://anti.space)*
