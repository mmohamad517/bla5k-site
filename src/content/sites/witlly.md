...
faqs:
  ...
  - q: What can you do with Witlly?
    a: "In practice, Witlly is used to speed up content creation work: Witlly is an all-in-one AI platform that assists with content creation, image generation, coding support, and includes features like real-time web search, speech-to-text transcription, and a voiceover tool, streamlining workflows for marketers and content creators.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Witlly best for?
...
*Official resource: [Witlly](http://witlly.com)*
