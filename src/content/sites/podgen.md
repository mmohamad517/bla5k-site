...
faqs:
  ...
  - q: What can you do with Podgen?
    a: "In practice, Podgen is used to speed up ai content generation work: PodGen.io converts text, YouTube videos and PDFs into podcast-ready audio with 50+ voices, voice cloning, multi-host and multilingual support, offering transcript editing, AI script/show-note generation, audio mastering, publishing workflows, RSS/API integration and analytics.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Podgen best for?
...
*Official resource: [Podgen](https://podgen.io)*
