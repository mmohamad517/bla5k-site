...
faqs:
  ...
  - q: What can you do with Edge?
    a: "In practice, Edge is used to speed up workflow automation work: Edge is an AI‑driven patent drafting platform that automates claims, descriptions, and background sections, generates publication‑ready figures, parses inventor disclosures, and adapts filings for USPTO and EPO.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Edge best for?
...
*Official resource: [Edge](https://www.withedge.com/)*
