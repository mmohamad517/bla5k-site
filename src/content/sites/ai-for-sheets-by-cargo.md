...
faqs:
  ...
  - q: What can you do with AI for Sheets by Cargo?
    a: "In practice, AI for Sheets by Cargo is used to speed up ai sales work: Cargo is an AI-powered Google Workspace add-on that assists in writing sales emails, follow-ups, Google Ad copy, and blog posts at scale using pre-built templates.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is AI for Sheets by Cargo best for?
  ...
  - q: How do I start with AI for Sheets by Cargo?
...
*Official resource: [AI for Sheets by Cargo](https://cargo.site/)*
