...
faqs:
  ...
  - q: What can you do with MindSmith?
    a: "In practice, MindSmith is used to speed up ai content generation work: Mindsmith is an AI-powered tool that simplifies instructional processes by generating high-quality on-demand learning content, providing a user-friendly platform for creating and sharing course materials and training.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is MindSmith best for?
  ...
  - q: How do I start with MindSmith?
...
*Official resource: [MindSmith](https://www.mindsmith.ai/)*
