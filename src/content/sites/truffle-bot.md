...
example: Give Truffle.bot one real task — a prompt, a file, or a request — and it returns a usable result for your conversational ai workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Truffle.bot?
    a: "In practice, Truffle.bot is used to speed up conversational ai work: Truffle automatically extracts and summarizes key information from Slack conversations, storing it in a searchable knowledge base.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Truffle.bot best for?
  ...
  - q: How do I start with Truffle.bot?
...
*Official resource: [Truffle.bot](https://truffle.bot/)*
