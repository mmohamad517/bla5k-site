...
example: Give QMD - Query Markup Documents one real task — a prompt, a file, or a request — and it returns a usable result for your ai management workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with QMD - Query Markup Documents?
    a: "In practice, QMD - Query Markup Documents is used to speed up ai management work: qmd is an on-device CLI search engine that indexes documentation, notes, and transcripts, preserving tree structure to return contextual subdocuments; it supports BM25, vector search, local embeddings, and LLM re-ranking to improve retrieval for LLM workflows.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is QMD - Query Markup Documents best for?
  ...
  - q: How do I start with QMD - Query Markup Documents?
...
*Official resource: [QMD - Query Markup Documents](https://github.com/tobi/qmd)*
