...
faqs:
  - q: What is Prometheus - Firecrawl?
    a: Prometheus simplifies web data collection by acting as a forward-deployed agent. Users describe their needs in plain English, triggering automatic TypeScript collector generation, testing, and either code delivery or scheduled data gathering – all with version control. AI Agents Free trial That is the core of what Prometheus - Firecrawl does — ai agent workflows handled by a dedicated AI tool rather than a general-purpose chatbot.
