...
faqs:
  - q: What is Marble?
    a: Marble generates persistent 3D worlds from text, images, video, panoramas, or 3D models, offers image stitching, a Studio editor with style presets, multi-world stitching, export collaboration, and cinematic 3D video output for iterative workflows. That is the core of what Marble does — 3D modeling handled by a dedicated AI tool rather than a general-purpose chatbot.
  - q: Is Marble free?
    a: Marble uses a freemium model, so there is a usable free tier with paid upgrades available. For exact limits and the current price of the paid plan, check the official website — pricing changes often.
  - q: What can you do with Marble?
    a: "In practice, Marble is used to speed up 3D modeling work: Marble generates persistent 3D worlds from text, images, video, panoramas, or 3D models, offers image stitching, a Studio editor with style presets, multi-world stitching, export collaboration, and cinematic 3D video output for iterative workflows.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Marble best for?
...
*Official resource: [Marble](https://marble.worldlabs.ai)*
