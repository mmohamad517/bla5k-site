...
faqs:
  ...
  - q: What can you do with OdysseyGPT?
    a: "In practice, OdysseyGPT is used to speed up ai agent workflows work: OdysseyGPT is an AI document intelligence tool for enterprises, enabling natural-language queries across large document sets, providing citation-backed answers, and ensuring data control with secure deployment options and robust access controls for compliance and auditability.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is OdysseyGPT best for?
  ...
  - q: How do I start with OdysseyGPT?
...
*Official resource: [OdysseyGPT](https://odysseygpt.ai)*
