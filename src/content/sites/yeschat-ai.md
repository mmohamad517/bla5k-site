...
faqs:
  ...
  - q: What can you do with YesChat AI?
    a: "In practice, YesChat AI is used to speed up conversational ai work: YesChat.ai unifies chat, music, video, and image generation in a browser platform, offering DeepSeek‑R1, GPT‑4o, and Claude 3.5 Sonnet for conversation, royalty‑free music from text, text‑to‑video, and image creation.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is YesChat AI best for?
  ...
  - q: How do I start with YesChat AI?
...
*Official resource: [YesChat AI](https://www.yeschat.ai)*
