...
faqs:
  ...
  - q: What can you do with Celebrity Agent?
    a: "In practice, Celebrity Agent is used to speed up ai marketing work: Celebrity Agent uses predictive analytics and MLS, title, and CRM data to surface high‑intent seller and off‑market leads, automate event‑triggered omni‑channel outreach (direct mail, email, SMS), and manage concierge workflows and pipeline reporting.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Celebrity Agent best for?
  ...
  - q: How do I start with Celebrity Agent?
...
*Official resource: [Celebrity Agent](https://pro.celebrityagent.com)*
