...
faqs:
  ...
  - q: What can you do with PromptLocker?
    a: "In practice, PromptLocker is used to speed up ai verification work: PromptLocker is an on‑prem/cloud governance layer that keeps client data in your account, logs every AI interaction in an append‑only audit trail, integrates with document stores without migration, and provides compliance reports and auditing tools for regulated firms.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is PromptLocker best for?
  ...
  - q: How do I start with PromptLocker?
...
*Official resource: [PromptLocker](https://www.promptlocker.ai)*
