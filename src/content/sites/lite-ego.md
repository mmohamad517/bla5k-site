...
faqs:
  ...
  - q: What can you do with Ego Lite?
    a: "In practice, Ego Lite is used to speed up ai agent workflows work: Ego lite is a browser-based platform that runs AI agents for web automation and parallel multitasking, sharing logged-in browser state and enabling zero-config tasks from a Chromium runtime.. The exact feature set is best confirmed with a quick test on the official site."
