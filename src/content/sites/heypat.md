...
example: Give HeyPat one real task — a prompt, a file, or a request — and it returns a usable result for your ai customer support workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with HeyPat?
    a: "In practice, HeyPat is used to speed up ai customer support work: HeyPat.ai is a conversational AI assistant that delivers instant answers on various topics through messaging platforms like Telegram and WhatsApp.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is HeyPat best for?
...
*Official resource: [HeyPat](https://www.heypat.ai/)*
