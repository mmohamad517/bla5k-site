...
example: Give Drift one real task — a prompt, a file, or a request — and it returns a usable result for your ai customer support workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Drift?
    a: "In practice, Drift is used to speed up ai customer support work: Drift is an AI chat agent that engages visitors, answers questions, qualifies leads, and routes them to reps or meetings.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Drift best for?
...
*Official resource: [Drift](https://www.drift.com/)*
