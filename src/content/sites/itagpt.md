...
example: Give ItaGPT one real task — a prompt, a file, or a request — and it returns a usable result for your conversational ai workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with ItaGPT?
    a: "In practice, ItaGPT is used to speed up conversational ai work: ItaGPT links OpenAI’s ChatGPT to WhatsApp, letting users send questions and receive real‑time AI answers within their chat app.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is ItaGPT best for?
...
*Official resource: [ItaGPT](https://itagpt.it/)*
