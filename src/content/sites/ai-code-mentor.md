...
faqs:
  ...
  - q: What can you do with AI Code Mentor?
    a: "In practice, AI Code Mentor is used to speed up ai assistance work: AI Code Mentor analyzes pasted JavaScript, Python, HTML, and CSS, providing detailed explanations, complexity metrics, automated refactoring, and code‑review alerts for errors and best‑practice violations, helping learners and developers improve code quality and efficiency.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is AI Code Mentor best for?
  ...
  - q: How do I start with AI Code Mentor?
...
*Official resource: [AI Code Mentor](https://code-mentor.ai/)*
