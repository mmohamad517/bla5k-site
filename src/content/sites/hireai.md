...
example: Give HireAI one real task — a prompt, a file, or a request — and it returns a usable result for your ai research workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with HireAI?
    a: "In practice, HireAI is used to speed up ai research work: Arc gives instant access to 450,000 professionals across 190 countries, with hiring timelines of 72 hours for freelance and up to 14 days for full‑time roles.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is HireAI best for?
...
*Official resource: [HireAI](https://arc.dev/)*
