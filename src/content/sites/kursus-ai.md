...
faqs:
  ...
  - q: What can you do with Kursus AI?
    a: "In practice, Kursus AI is used to speed up ai agent workflows work: Kursus AI is an AI-driven tool for analyzing candidate resumes, streamlining recruitment by allowing bulk CV uploads, tailored job postings, and mobile access, enhancing efficiency in candidate selection and management.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Kursus AI best for?
  ...
  - q: How do I start with Kursus AI?
...
*Official resource: [Kursus AI](https://www.kursus-ai.fr)*
