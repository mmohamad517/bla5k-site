...
example: Give SayHi one real task — a prompt, a file, or a request — and it returns a usable result for your ai marketing workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with SayHi?
    a: "In practice, SayHi is used to speed up ai marketing work: SayHi is a Chrome extension that automates LinkedIn outreach by generating personalized messages from a contact’s profile.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is SayHi best for?
...
*Official resource: [SayHi](https://sayhi.pro/)*
