...
faqs:
  ...
  - q: What can you do with Frigate NVR?
    a: "In practice, Frigate NVR is used to speed up ai agent workflows work: Frigate NVR is an open-source on‑premise NVR that runs local AI object detection and real-time tracking on camera feeds, supports hardware accelerators and custom models, configurable detection zones, and integrates with Home Assistant, Node-RED, MQTT for automations.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Frigate NVR best for?
  ...
  - q: How do I start with Frigate NVR?
...
*Official resource: [Frigate NVR](https://frigate.video)*
