...
faqs:
  ...
  - q: What can you do with writewithspiral.com?
    a: "In practice, writewithspiral.com is used to speed up ai copywriting work: Spiral is an AI writing partner that asks targeted questions to clarify intent, generates multiple draft angles, learns brand voice from examples, ingests documents to ground content, and supports collaborative workflows for export-ready social, landing, presentation, and documentation copy.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is writewithspiral.com best for?
  ...
  - q: How do I start with writewithspiral.com?
...
*Official resource: [writewithspiral.com](https://writewithspiral.com)*
