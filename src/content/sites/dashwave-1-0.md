...
faqs:
  ...
  - q: What can you do with Dashwave 1.0?
    a: "In practice, Dashwave 1.0 is used to speed up no-code building work: Dashwave is a cloud-based platform for mobile app development that streamlines the process with one-click workspaces, collaborative emulators, and accelerated builds.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Dashwave 1.0 best for?
  ...
  - q: How do I start with Dashwave 1.0?
...
*Official resource: [Dashwave 1.0](https://dashwave.io)*
