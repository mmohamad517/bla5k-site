...
example: Give Getgro.io one real task — a prompt, a file, or a request — and it returns a usable result for your ai customer support workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with Getgro.io?
    a: "In practice, Getgro.io is used to speed up ai customer support work: Getgro centralizes live chat, email, WhatsApp, Instagram and other channels into one support dashboard.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Getgro.io best for?
  ...
  - q: How do I start with Getgro.io?
...
*Official resource: [Getgro.io](https://getgro.io)*
