...
faqs:
  ...
  - q: What can you do with Filmbase?
    a: "In practice, Filmbase is used to speed up ai management work: FilmBase is production management software that uses on-device AI to automate script breakdowns and tagging, optimize scheduling and stripboards, manage budgets, call sheets, locations and shotlists, link storyboards to camera plans, and store projects offline.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Filmbase best for?
  ...
  - q: How do I start with Filmbase?
...
*Official resource: [Filmbase](https://www.filmbase.io)*
