...
faqs:
  ...
  - q: What can you do with Superapp?
    a: "In practice, Superapp is used to speed up no-code building work: Superapp generates production-ready native Swift iPhone apps from plain-English descriptions, using AI to design screens, assemble Swift code, and guide App Store publishing—enabling non-developers to build prototypes, MVPs, and native App Store releases without manual coding.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Superapp best for?
  ...
  - q: How do I start with Superapp?
...
*Official resource: [Superapp](https://www.superappp.com)*
