...
faqs:
  ...
  - q: What is the difference between Git and GitHub?
    a: Git is the underlying version-control system that tracks changes to code on your computer. GitHub is a cloud platform built around Git that hosts your repositories online and adds collaboration features like pull requests, issues, code review, and CI/CD. You can use Git without GitHub, but GitHub makes working together far easier.
  - q: Who owns GitHub?
    a: GitHub is owned by Microsoft, which acquired it in 2018. Despite the acquisition, GitHub continues to operate as its own platform and remains the home of a vast amount of open-source software used across the entire industry.
  - q: Do I need to know how to code to use GitHub?
    a: Coding helps, but not everyone on GitHub is a programmer. Writers, designers, researchers, and project managers use it to track documents, manage tasks through issues, and collaborate on projects. That said, its core audience is software developers.
  - q: What are GitHub Actions?
    a: GitHub Actions is a built-in automation and CI/CD system. It lets you automatically build, test, and deploy your code whenever you push changes, using configurable workflows. It removes the need for a separate CI service for many projects.
  - q: Is GitHub good for beginners?
    a: Absolutely. GitHub is the standard place to learn, build a portfolio, and contribute to open source. Your public repositories act as a visible résumé for employers, and millions of open projects give beginners real code to study and learn from.
---
...
*Official resource: [GitHub](https://github.com)*