...
faqs:
  ...
  - q: What can you do with Reasonix?
    a: "In practice, Reasonix is used to speed up ai assistance work: Reasonix.io is a terminal-native AI coding agent that leverages Deepseek’s byte-stable prefix cache to achieve 90%+ cache hits, slashing input-token costs to roughly one-fifth.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is Reasonix best for?
  ...
  - q: How do I start with Reasonix?
...
*Official resource: [Reasonix](https://reasonix.io/)*
