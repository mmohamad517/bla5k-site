...
example: Give June AI one real task — a prompt, a file, or a request — and it returns a usable result for your ai planning workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with June AI?
    a: "In practice, June AI is used to speed up ai planning work: June is an AI‑driven analytics platform for B2B SaaS that lets teams query user data via SQL or natural language.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is June AI best for?
...
*Official resource: [June AI](https://www.june.so/ai)*
