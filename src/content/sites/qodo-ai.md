...
faqs:
  ...
  - q: What can you do with qodo.ai?
    a: "In practice, qodo.ai is used to speed up ai assistance work: Qodo is an AI code-review platform that integrates with IDEs, pull requests, CLI and CI/CD to provide context-aware, cross-repo analysis, automated bug/security detection, test and docs suggestions, inline fix candidates, and configurable governance for enterprise workflows.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is qodo.ai best for?
...
*Official resource: [qodo.ai](https://qodo.ai)*
