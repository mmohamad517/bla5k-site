...
example: Give TheySaid one real task — a prompt, a file, or a request — and it returns a usable result for your ai customer support workflow.
goodFor:
...
faqs:
  ...
  - q: What can you do with TheySaid?
    a: "In practice, TheySaid is used to speed up ai customer support work: TheySay is an AI-driven survey platform that enhances engagement and feedback accuracy through conversational methods, personalized questions, and an automated chatbot, enabling organizations to gather deeper insights and improve customer experience.. The exact feature set is best confirmed with a quick test on the official site."
  - q: Who is TheySaid best for?
  ...
  - q: How do I start with TheySaid?
...
*Official resource: [TheySaid](https://www.theysaid.io/)*
